...
var UserTimeDiffFormat = function (_Component) {
	...
	_createClass(UserTimeDiffFormat, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(_DateTimeDiffFormat2.default, { from: currentTimeUTCString, fromTimeZone: timeZoneString, to: to,
...
UserTimeDiffFormat.contextTypes = {
	timeZone: _react.PropTypes.object
};