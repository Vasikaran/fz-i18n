...
exports.ConnectI18NProvider = exports.i18nUtils = undefined;
...
var I18NProvider = function (_React$Component) {
  ...
  function I18NProvider(props, context) {
    ...
    i18nUtils.getI18NValue = (0, _utils.getI18NValue)(props.i18n);
    i18nUtils.userDateFormat = (0, _utils.userDateFormat)(i18nUtils.getI18NValue, props.timeZone);
    return _this;
  }
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.i18n != nextProps.i18n || this.props.timeZone != nextProps.timeZone && this.promise) {
        this.promise = new Promise(function (res, rej) {
          ...
          i18nUtils.getI18NValue = (0, _utils.getI18NValue)(nextProps.i18n);
          i18nUtils.userDateFormat = (0, _utils.userDateFormat)(i18nUtils.getI18NValue, nextProps.timeZone);
