...
var I18NProvider = function (_React$Component) {
  ...
  _createClass(I18NProvider, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (this.props.i18n != nextProps.i18n || this.props.timeZone != nextProps.timeZone || this.props.user != nextProps.user || this.props.permission != nextProps.permission && this.promise) {
