	...
	_createClass(I18N, [{
		...
		value: function createElement() {
			...
			var props = Object.keys(this.props).reduce(function (result, nextKey) {
				if (nextKey != "i18NKey" && nextKey != "tag" && nextKey != "values") result[nextKey] = _this2.props[nextKey];
				return result;
			}, {});
			var child = this.getI18NValue();
...
I18N.propTypes = {
	i18NKey: _react.PropTypes.object.isRequired,
