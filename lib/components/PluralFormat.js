...
var PluralFormat = function (_React$Component) {
	...
	_createClass(PluralFormat, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(_FormatText2.default, _extends({}, this.props, { i18NKey: key, values: values, one: null, many: null, zero: null }));
		}
	}]);
...
PluralFormat.propTypes = {
	one: _react.PropTypes.string,
	many: _react.PropTypes.string,
	zero: _react.PropTypes.string,
