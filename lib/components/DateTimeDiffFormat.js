    ...
    _createClass(DateTimeDiffFormat, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'span',
                null,
                _react2.default.createElement(_FormatText2.default, { i18NKey: key, values: values }),
                ' ',
                isSuffixEnable && _react2.default.createElement(_FormatText2.default, { i18NKey: suffix })
            );
        }
    }]);
...
DateTimeDiffFormat.propTypes = {
    ...
    tommorrow: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.object]),
    yesterday: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.object]),
    today: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.object]),
